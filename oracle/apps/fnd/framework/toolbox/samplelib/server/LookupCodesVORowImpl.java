...
public class LookupCodesVORowImpl extends OAViewRowImpl {
    ...
    public static final String RCS_ID="$Header: LookupCodesVORowImpl.java 120.5 2006/07/03 17:07:58 atgops1 noship $";
  public static final boolean RCS_ID_RECORDED =
    ...
    public static final int STARTDATEACTIVE = 3;
    public static final int ENDDATEACTIVE = 4;
