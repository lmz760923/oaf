 ...
 * Table:  FWK_TBX_ITEMS
 */
public class ItemEOImpl extends OAEntityImpl {

    public static final int ITEMID = 0;
    public static final String RCS_ID="$Header: ItemEOImpl.java 120.2 2006/07/03 19:27:52 atgops1 noship $";
  public static final boolean RCS_ID_RECORDED =
    ...
    public static final int ENABLEDFLAG = 4;
    public static final int SUMMARYFLAG = 5;
    public static final int SEGMENT1 = 6;
    public static final int SEGMENT2 = 7;
    public static final int SEGMENT3 = 8;
    public static final int SEGMENT4 = 9;
  ...
  public ItemEOImpl()
  {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("oracle.apps.fnd.framework.toolbox.schema.server.ItemEO");
        }
