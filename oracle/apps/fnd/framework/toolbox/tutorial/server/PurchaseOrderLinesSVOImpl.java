...
public class PurchaseOrderLinesSVOImpl extends OAViewObjectImpl {

  /**
   * Oracle Applications internal source control identifier
   */
   public static final String RCS_ID="$Header: PurchaseOrderLinesSVOImpl.java 120.3 2006/07/04 01:19:39 atgops1 noship $";
  /**
   * Oracle Applications internal source control identifier
   */
   ...
   */
  public PurchaseOrderLinesSVOImpl()
  {
  }
}