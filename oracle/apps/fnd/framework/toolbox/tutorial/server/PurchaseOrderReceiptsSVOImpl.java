...
public class PurchaseOrderReceiptsSVOImpl extends OAViewObjectImpl {
  /**
   * Oracle Applications internal source control identifier
   */
   public static final String RCS_ID="$Header: PurchaseOrderReceiptsSVOImpl.java 120.3 2006/07/04 01:30:54 atgops1 noship $";
  /**
   * Oracle Applications internal source control identifier
   */
   ...
   */
  public PurchaseOrderReceiptsSVOImpl()
  {
  }
}