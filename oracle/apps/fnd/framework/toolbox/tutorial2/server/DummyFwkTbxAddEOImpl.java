...
// ---------------------------------------------------------------------
public class DummyFwkTbxAddEOImpl extends OAEntityImpl {
	  public static final String RCS_ID = "$Header: DummyFwkTbxAddEOImpl.java 120.0.12020000.1 2020/01/08 04:50:12 spunam noship $";
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject =
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("oracle.apps.fnd.framework.toolbox.tutorial2.server.DummyFwkTbxAddEO");
        }
