 ...
 * Controller for ...
 */
public class FwkTbxNewEmpExpCO
  extends OAControllerImpl
{
  public static final String RCS_ID = "$Header: FwkTbxNewEmpExpCO.java 120.0.12020000.1 2020/01/08 08:05:48 spunam noship $";
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    final String currentClassName = "FwkTbxNewEmpExpCO";
    ...
    String voName = new String("FwkTbxNewExperienceVO1");
