 ...
 * Controller for ...
 */
public class FwkTbxNewEmpTrainingCO
  extends OAControllerImpl
{
  public static final String RCS_ID = "$Header: FwkTbxNewEmpTrainingCO.java 120.0.12020000.1 2020/01/08 08:21:25 spunam noship $";
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    final String currentClassName = "FwkTbxNewEmpTrainingCo";
    ...
    String voName = new String("FwkTbxNewEmpTrainingVO1");
